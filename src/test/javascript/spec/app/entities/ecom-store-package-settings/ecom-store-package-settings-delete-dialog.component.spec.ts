...
import { EcomStorePackageSettingsDeleteDialogComponent } from 'app/entities/ecom-store-package-settings/ecom-store-package-settings-delete-dialog.component';
