...
import { CarrierServiceComponent } from 'app/entities/carrier-service/carrier-service.component';
...
describe('Component Tests', () => {
  describe('CarrierService Management Component', () => {
    let comp: CarrierServiceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CarrierServiceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.carrierServices && comp.carrierServices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
