...
class SisyphusSubJobResourceIT {
  ...
  private static final String DEFAULT_RUN_ORDER = "AAAAAAAAAA";
  private static final String UPDATED_RUN_ORDER = "BBBBBBBBBB";
  ...
  public static SisyphusSubJob createEntity(EntityManager em) {
    SisyphusSubJob sisyphusSubJob = new SisyphusSubJob().runOrder(DEFAULT_RUN_ORDER);
  ...
  public static SisyphusSubJob createUpdatedEntity(EntityManager em) {
    SisyphusSubJob sisyphusSubJob = new SisyphusSubJob().runOrder(UPDATED_RUN_ORDER);
    return sisyphusSubJob;
  }
  ...
  void createSisyphusSubJob() throws Exception {
    ...
    assertThat(testSisyphusSubJob.getRunOrder()).isEqualTo(DEFAULT_RUN_ORDER);
  }
  ...
  void getAllSisyphusSubJobs() throws Exception {
    ...
    restSisyphusSubJobMockMvc
      ...
      .andExpect(jsonPath("$.[*].runOrder").value(hasItem(DEFAULT_RUN_ORDER)));
  }
  ...
  void getSisyphusSubJob() throws Exception {
    ...
    restSisyphusSubJobMockMvc
      ...
      .andExpect(jsonPath("$.runOrder").value(DEFAULT_RUN_ORDER));
  }
  ...
  void putNewSisyphusSubJob() throws Exception {
    ...
    updatedSisyphusSubJob.runOrder(UPDATED_RUN_ORDER);
    ...
    SisyphusSubJob testSisyphusSubJob = sisyphusSubJobList.get(sisyphusSubJobList.size() - 1);
    assertThat(testSisyphusSubJob.getRunOrder()).isEqualTo(UPDATED_RUN_ORDER);
  }
  ...
  void fullUpdateSisyphusSubJobWithPatch() throws Exception {
    ...
    partialUpdatedSisyphusSubJob.runOrder(UPDATED_RUN_ORDER);
