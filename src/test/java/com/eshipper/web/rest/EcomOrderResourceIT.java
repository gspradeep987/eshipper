...
class EcomOrderResourceIT {
  ...
  private static final String ENTITY_API_URL = "/api/ecom-orders";
  ...
  @Test
  @Transactional
  void createEcomOrder() throws Exception {
    ...
    restEcomOrderMockMvc
      .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(ecomOrderDTO)))
    ...
    assertThat(testEcomOrder.getIsCancelled()).isEqualTo(DEFAULT_IS_CANCELLED);
    assertThat(testEcomOrder.getIsShipped()).isEqualTo(DEFAULT_IS_SHIPPED);
    assertThat(testEcomOrder.getEshipperStatus()).isEqualTo(DEFAULT_ESHIPPER_STATUS);
    assertThat(testEcomOrder.getResidentialShippingAddress()).isEqualTo(DEFAULT_RESIDENTIAL_SHIPPING_ADDRESS);
    ...
    assertThat(testEcomOrder.getIsCancelSchedule()).isEqualTo(DEFAULT_IS_CANCEL_SCHEDULE);
    assertThat(testEcomOrder.getIsSchedulePickup()).isEqualTo(DEFAULT_IS_SCHEDULE_PICKUP);
    assertThat(testEcomOrder.getPackageTypeId()).isEqualTo(DEFAULT_PACKAGE_TYPE_ID);
  }

  @Test
  @Transactional
  void createEcomOrderWithExistingId() throws Exception {
  ...
  @Test
  @Transactional
  void getAllEcomOrders() throws Exception {
  ...
  @Test
  @Transactional
  void getEcomOrder() throws Exception {
    // Initialize the database
    ecomOrderRepository.saveAndFlush(ecomOrder);

    // Get the ecomOrder
    restEcomOrderMockMvc
      .perform(get(ENTITY_API_URL_ID, ecomOrder.getId()))
      .andExpect(status().isOk())
      .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  @Test
  @Transactional
  void getNonExistingEcomOrder() throws Exception {
    // Get the ecomOrder
    restEcomOrderMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
  }

  @Test
  @Transactional
  void putNewEcomOrder() throws Exception {
    // Initialize the database
    ecomOrderRepository.saveAndFlush(ecomOrder);
    ...
    restEcomOrderMockMvc
      .perform(
        put(ENTITY_API_URL_ID, ecomOrderDTO.getId())
    ...
    assertThat(testEcomOrder.getIsCancelled()).isEqualTo(UPDATED_IS_CANCELLED);
    assertThat(testEcomOrder.getIsShipped()).isEqualTo(UPDATED_IS_SHIPPED);
    assertThat(testEcomOrder.getEshipperStatus()).isEqualTo(UPDATED_ESHIPPER_STATUS);
    assertThat(testEcomOrder.getResidentialShippingAddress()).isEqualTo(UPDATED_RESIDENTIAL_SHIPPING_ADDRESS);
    ...
    assertThat(testEcomOrder.getIsCancelSchedule()).isEqualTo(UPDATED_IS_CANCEL_SCHEDULE);
    assertThat(testEcomOrder.getIsSchedulePickup()).isEqualTo(UPDATED_IS_SCHEDULE_PICKUP);
    assertThat(testEcomOrder.getPackageTypeId()).isEqualTo(UPDATED_PACKAGE_TYPE_ID);
  }

  @Test
  @Transactional
  void putNonExistingEcomOrder() throws Exception {
    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();
    ecomOrder.setId(count.incrementAndGet());
  ...
  @Test
  @Transactional
  void putWithIdMismatchEcomOrder() throws Exception {
    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();
    ecomOrder.setId(count.incrementAndGet());
  ...
  @Test
  @Transactional
  void putWithMissingIdPathParamEcomOrder() throws Exception {
    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();
    ecomOrder.setId(count.incrementAndGet());
    ...
    // If url ID doesn't match entity ID, it will throw BadRequestAlertException
    restEcomOrderMockMvc
      .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(ecomOrderDTO)))
  ...
  @Test
  @Transactional
  void partialUpdateEcomOrderWithPatch() throws Exception {
    // Initialize the database
    ecomOrderRepository.saveAndFlush(ecomOrder);

    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();

    // Update the ecomOrder using partial update
    EcomOrder partialUpdatedEcomOrder = new EcomOrder();
    partialUpdatedEcomOrder.setId(ecomOrder.getId());

    partialUpdatedEcomOrder
      .ecomOrderNumber(UPDATED_ECOM_ORDER_NUMBER)
      .customerName(UPDATED_CUSTOMER_NAME)
      .name(UPDATED_NAME)
      .email(UPDATED_EMAIL)
    ...
    restEcomOrderMockMvc
      .perform(
        patch(ENTITY_API_URL_ID, partialUpdatedEcomOrder.getId())
          .contentType("application/merge-patch+json")
          .content(TestUtil.convertObjectToJsonBytes(partialUpdatedEcomOrder))
      )
      .andExpect(status().isOk());
  ...
  @Test
  @Transactional
  void fullUpdateEcomOrderWithPatch() throws Exception {
    // Initialize the database
    ecomOrderRepository.saveAndFlush(ecomOrder);
  ...
  @Test
  @Transactional
  void patchNonExistingEcomOrder() throws Exception {
    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();
    ecomOrder.setId(count.incrementAndGet());
    ...
    restEcomOrderMockMvc
      .perform(
        patch(ENTITY_API_URL_ID, ecomOrderDTO.getId())
          .contentType("application/merge-patch+json")
          .content(TestUtil.convertObjectToJsonBytes(ecomOrderDTO))
      )
      .andExpect(status().isBadRequest());
  ...
  @Test
  @Transactional
  void patchWithIdMismatchEcomOrder() throws Exception {
    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();
    ecomOrder.setId(count.incrementAndGet());
  ...
  @Test
  @Transactional
  void patchWithMissingIdPathParamEcomOrder() throws Exception {
    int databaseSizeBeforeUpdate = ecomOrderRepository.findAll().size();
    ecomOrder.setId(count.incrementAndGet());
    ...
    // If url ID doesn't match entity ID, it will throw BadRequestAlertException
    restEcomOrderMockMvc
      .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(ecomOrderDTO)))
      .andExpect(status().isMethodNotAllowed());
  ...
  @Test
  @Transactional
  void deleteEcomOrder() throws Exception {
    // Initialize the database
    ecomOrderRepository.saveAndFlush(ecomOrder);
    ...
    restEcomOrderMockMvc
      .perform(delete(ENTITY_API_URL_ID, ecomOrder.getId()).accept(MediaType.APPLICATION_JSON))
