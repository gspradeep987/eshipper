...
public class SisyphusClassesResource {
  ...
  public ResponseEntity<List<SisyphusClassesDTO>> getAllSisyphusClasses(Pageable pageable) {
    log.debug("REST request to get a page of SisyphusClasses");
    Page<SisyphusClassesDTO> page = sisyphusClassesService.findAll(pageable);
