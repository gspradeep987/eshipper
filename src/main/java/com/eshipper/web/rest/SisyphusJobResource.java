...
public class SisyphusJobResource {
  ...
  public ResponseEntity<List<SisyphusJobDTO>> getAllSisyphusJobs(Pageable pageable) {
    log.debug("REST request to get a page of SisyphusJobs");
    Page<SisyphusJobDTO> page = sisyphusJobService.findAll(pageable);
