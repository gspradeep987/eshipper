...
/**
 * Spring Data  repository for the EcomProduct entity.
 */
@Repository
public interface EcomProductRepository extends JpaRepository<EcomProduct, Long> {

    @Query(value = "select distinct ecomProduct from EcomProduct ecomProduct left join fetch ecomProduct.ecomWarehouses",
