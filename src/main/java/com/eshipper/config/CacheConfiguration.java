...
public class CacheConfiguration {
  ...
  public JCacheManagerCustomizer cacheManagerCustomizer() {
    return cm -> {
      ...
      createCache(cm, com.eshipper.domain.SisyphusJob.class.getName());
      createCache(cm, com.eshipper.domain.SisyphusJob.class.getName() + ".subJobs");
      createCache(cm, com.eshipper.domain.SisyphusJob.class.getName() + ".params");
      createCache(cm, com.eshipper.domain.SisyphusSubJob.class.getName());
      createCache(cm, com.eshipper.domain.SisyphusJobParam.class.getName());
      createCache(cm, com.eshipper.domain.SisyphusClient.class.getName());
      createCache(cm, com.eshipper.domain.SisyphusClasses.class.getName());
      createCache(cm, com.eshipper.domain.SisyphusJobType.class.getName());
