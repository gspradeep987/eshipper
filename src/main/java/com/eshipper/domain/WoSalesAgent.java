...
public class WoSalesAgent implements Serializable {
    ...
    public ElasticSearchWoSalesAgent getElasticSearchWoSalesAgent() {
        return elasticSearchWoSalesAgent;
    }

    public WoSalesAgent elasticSearchWoSalesAgent(ElasticSearchWoSalesAgent elasticSearchWoSalesAgent) {
        this.elasticSearchWoSalesAgent = elasticSearchWoSalesAgent;
        return this;
    }

    public void setElasticSearchWoSalesAgent(ElasticSearchWoSalesAgent elasticSearchWoSalesAgent) {
        this.elasticSearchWoSalesAgent = elasticSearchWoSalesAgent;
    }
