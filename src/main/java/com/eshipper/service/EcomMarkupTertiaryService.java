...
public interface EcomMarkupTertiaryService {
  ...
  /**
   * Partially updates a ecomMarkupTertiary.
   *
   * @param ecomMarkupTertiaryDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomMarkupTertiaryDTO> partialUpdate(EcomMarkupTertiaryDTO ecomMarkupTertiaryDTO);
