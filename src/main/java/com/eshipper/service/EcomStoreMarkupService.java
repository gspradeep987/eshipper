...
public interface EcomStoreMarkupService {
  ...
  /**
   * Partially updates a ecomStoreMarkup.
   *
   * @param ecomStoreMarkupDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomStoreMarkupDTO> partialUpdate(EcomStoreMarkupDTO ecomStoreMarkupDTO);
