...
public interface EcomStorePackageSettingsService {
  ...
  /**
   * Partially updates a ecomStorePackageSettings.
   *
   * @param ecomStorePackageSettingsDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomStorePackageSettingsDTO> partialUpdate(EcomStorePackageSettingsDTO ecomStorePackageSettingsDTO);
