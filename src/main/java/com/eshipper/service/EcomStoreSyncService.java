...
public interface EcomStoreSyncService {
  ...
  /**
   * Partially updates a ecomStoreSync.
   *
   * @param ecomStoreSyncDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomStoreSyncDTO> partialUpdate(EcomStoreSyncDTO ecomStoreSyncDTO);
