...
public interface EcomMarkupSecondaryService {
  ...
  /**
   * Partially updates a ecomMarkupSecondary.
   *
   * @param ecomMarkupSecondaryDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomMarkupSecondaryDTO> partialUpdate(EcomMarkupSecondaryDTO ecomMarkupSecondaryDTO);
