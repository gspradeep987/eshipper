 ...
 */
@Mapper(componentModel = "spring", uses = {ElasticSearchWoSalesAgentMapper.class, WoSalesAgentDetailsMapper.class, WoSalesCommissionDetailsMapper.class, WoSalesOperationalDetailsMapper.class, WoSalesCommissionTransferMapper.class, SalesAgentTypeMapper.class})
public interface WoSalesAgentMapper extends EntityMapper<WoSalesAgentDTO, WoSalesAgent> {

    @Mapping(source = "elasticSearchWoSalesAgent.id", target = "elasticSearchWoSalesAgentId")
    ...
    @Mapping(source = "elasticSearchWoSalesAgentId", target = "elasticSearchWoSalesAgent")
