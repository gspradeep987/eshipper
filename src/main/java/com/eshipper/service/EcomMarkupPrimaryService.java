...
public interface EcomMarkupPrimaryService {
  ...
  /**
   * Partially updates a ecomMarkupPrimary.
   *
   * @param ecomMarkupPrimaryDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomMarkupPrimaryDTO> partialUpdate(EcomMarkupPrimaryDTO ecomMarkupPrimaryDTO);
