...
public class WoSalesAgentDTO implements Serializable {
    ...
    private Long elasticSearchWoSalesAgentId;
    ...
    public Long getElasticSearchWoSalesAgentId() {
        return elasticSearchWoSalesAgentId;
    }

    public void setElasticSearchWoSalesAgentId(Long elasticSearchWoSalesAgentId) {
        this.elasticSearchWoSalesAgentId = elasticSearchWoSalesAgentId;
    }
    ...
    public String toString() {
        return "WoSalesAgentDTO{" +
            "id=" + getId() +
            ", isActive='" + isIsActive() + "'" +
            ", elasticSearchWoSalesAgentId=" + getElasticSearchWoSalesAgentId() +
