...
public interface EcomWarehouseService {
  ...
  /**
   * Partially updates a ecomWarehouse.
   *
   * @param ecomWarehouseDTO the entity to update partially.
   * @return the persisted entity.
   */
  Optional<EcomWarehouseDTO> partialUpdate(EcomWarehouseDTO ecomWarehouseDTO);
