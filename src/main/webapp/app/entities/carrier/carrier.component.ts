...
export class CarrierComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.carrierService
      ...
      .subscribe(
        (res: HttpResponse<ICarrier[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInCarriers(): void {
    this.eventSubscriber = this.eventManager.subscribe('carrierListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICarrier[] | null, headers: HttpHeaders, page: number): void {
