...
type EntityResponseType = HttpResponse<IShipmentService>;
type EntityArrayResponseType = HttpResponse<IShipmentService[]>;

@Injectable({ providedIn: 'root' })
export class ShipmentServiceService {
  public resourceUrl = SERVER_API_URL + 'api/shipment-services';
  ...
  update(shipmentService: IShipmentService): Observable<EntityResponseType> {
    return this.http.put<IShipmentService>(this.resourceUrl, shipmentService, { observe: 'response' });
  }
