  ...
  describe('SisyphusClasses Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call SisyphusSubJob query and add missing value', () => {
        ...
        const sisyphusClasses: ISisyphusSubJob = { id: 68863 };
        sisyphusClasses.sisyphusClasses = sisyphusClasses;

        const sisyphusSubJobCollection: ISisyphusSubJob[] = [{ id: 96526 }];
        spyOn(sisyphusSubJobService, 'query').and.returnValue(of(new HttpResponse({ body: sisyphusSubJobCollection })));
        const additionalSisyphusSubJobs = [sisyphusClasses];
      ...
      it('Should update editForm', () => {
        const sisyphusClasses: ISisyphusClasses = { id: 456 };
        const sisyphusClasses: ISisyphusSubJob = { id: 68576 };
        sisyphusClasses.sisyphusClasses = sisyphusClasses;
        ...
        expect(comp.sisyphusSubJobsSharedCollection).toContain(sisyphusClasses);
      });
    });
