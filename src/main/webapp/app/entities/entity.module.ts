...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'ecom-order-fullfillment-status',
        loadChildren: () =>
          import('./ecom-order-fullfillment-status/ecom-order-fullfillment-status.module').then(
            m => m.EshipperEcomOrderFullfillmentStatusModule
          ),
      },
      {
        path: 'ecom-order-payment-status',
        loadChildren: () =>
          import('./ecom-order-payment-status/ecom-order-payment-status.module').then(m => m.EshipperEcomOrderPaymentStatusModule),
      },
      {
        path: 'ecom-order-serch-type',
        loadChildren: () => import('./ecom-order-serch-type/ecom-order-serch-type.module').then(m => m.EshipperEcomOrderSerchTypeModule),
      },
