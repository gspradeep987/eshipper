...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'elastic-search-wo-sales-agent',
        loadChildren: () =>
          import('./elastic-search-wo-sales-agent/elastic-search-wo-sales-agent.module').then(
            m => m.EshipperElasticSearchWoSalesAgentModule
          ),
      },
      {
        path: 'elastic-status',
